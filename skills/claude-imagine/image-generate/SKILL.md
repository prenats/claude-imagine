---
name: image-generate
description: Transform descriptions into ultra-detailed prompts, then generate real images via the image generation server. Supports custom types, styles, moods, lighting, and composition with optional sub-agent delegation.
...
**Input:** `/image-generate a cozy coffee shop on a rainy evening`
